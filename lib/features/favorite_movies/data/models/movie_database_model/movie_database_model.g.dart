...
part of 'movie_database_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class MovieDatabaseModelAdapter extends TypeAdapter<MovieDatabaseModel> {
  @override
  final int typeId = 0;

  @override
  MovieDatabaseModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, MovieDatabaseModel obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is MovieDatabaseModelAdapter &&
